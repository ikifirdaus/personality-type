      ...
      <footer id="contact" className="bg-gray-900 text-white pt-16 pb-8 w-full">
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Neuroscience Jungian Personality Type - Pendekatan holistik
                untuk pengembangan diri melalui pemahaman fungsi kognitif dan
                arketipe.
              </p>
          ...
          <div className="pt-8 border-t border-gray-800 text-center text-gray-500 text-sm">
            <p>
              © {new Date().getFullYear()} NJPT (Neuroscience Jungian
              Personality Type). All rights reserved.
            </p>
          </div>
        </div>
      </footer>
