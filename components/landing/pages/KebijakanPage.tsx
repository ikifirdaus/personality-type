      ...
      <div className="py-16 bg-white min-h-screen px-6 md:px-12">
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            alamat email, usia, jenis kelamin, dan data tes lainnya. Selain itu,
            kami juga dapat mengumpulkan informasi teknis seperti alamat IP,
            jenis perangkat, dan aktivitas penggunaan aplikasi untuk
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6">
            <li>Menyediakan hasil tes kepribadian yang relevan dan akurat.</li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            pembayaran, dengan syarat mereka hanya menggunakan data untuk tujuan
            yang sesuai dan sesuai dengan kebijakan privasi ini.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">5. Penggunaan Cookie</h2>
          <p>
            ...
            Anda dapat mengatur browser Anda untuk menolak cookie, namun hal ini
            dapat memengaruhi fungsionalitas aplikasi.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            terdaftar. Kami mendorong Anda untuk memeriksa kebijakan ini secara
            berkala.
          </p>
        </section>
